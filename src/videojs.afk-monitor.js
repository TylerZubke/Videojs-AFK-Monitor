    ...
    function AFKMonitor(options){
        var player   = this,
            defaults = {
                ...
                containerClass: 'vjs-afk-container',
                continueButtonText: 'Yes, Continue',
                continueButtonClass: 'afk-button',
                stopButtonText: 'No',
                stopButtonClass: 'afk-button',
                waitClass: '',
                showMessageAfter: 5000, //in ms
                pausePlayerAfter: 5000, //in ms
        ...
        var hideContainer = function() {
            if( !containerDiv.className.match(/\b\s*hidden\b/) )
                containerDiv.className += ' hidden';
        };
        var showContainer = function() {
            containerDiv.className = containerDiv.className.replace(/\b\s*hidden\b/, '');
        };
        ...
        var init = function(){
            ...
            continueButton.className = 'vjs-afk-button ' + settings.continueButtonClass;
            ...
            stopButton.className = 'vjs-afk-button ' + settings.stopButtonClass;
